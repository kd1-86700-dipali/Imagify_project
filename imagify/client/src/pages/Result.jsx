  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] justify-center items-center'>
      ...
      <div className='relative'>
             <img src={image} className='max-w-sm rounded' width={270}/>
...
{!isImagedLoaded && 
    ...
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
        ...
        type='text ' placeholder='Describe what you want to generate'
         ...
         outline-none ml-8 mx-sm:w-20 'placeholder-color/>
...
{isImagedLoaded && 
    ...
    text-sm p-0.5 mt-10 rounded-full'>
      ...
      text-black px-10 py-3 rounded-full cursor-pointer'>
        Generate Another
      </p>
      <a href={image} download className='bg-zinc-900
       px-10 py-3 rounded-full cursor-pointer'>Download</a>
    </div>
}
    </form>
